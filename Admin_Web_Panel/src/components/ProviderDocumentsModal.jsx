...
import { X, FileText, CheckCircle, AlertCircle, FileCheck } from 'lucide-react';
...
const ProviderDocumentsModal = ({ provider, onClose, onUpdate }) => {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
            <div style={{
              ...
              <FileCheck size={36} style={{ color: '#059669' }} />
            </div>
            <div>
              ...
              <div style={{
                ...
                KYC Status: <strong style={{ 
                  color: provider.kycStatus === 'Verified' ? '#059669' : (provider.kycStatus === 'Rejected' ? '#DC2626' : '#D97706') 
                }}>{provider.kycStatus || 'Pending'}</strong>
              </div>
            </div>
          </div>
          <button 
...
export default ProviderDocumentsModal;
