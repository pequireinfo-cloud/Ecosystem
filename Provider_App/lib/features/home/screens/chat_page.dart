...
import 'package:pequire_provider_app/core/services/chat_service.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text(widget.userName, style: AppTypography.h3.copyWith(fontSize: 16)),
            const Text('Customer', style: TextStyle(color: Color(0xFF64748B), fontSize: 11)),
          ],
        ),
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // In a real app, check against current provider's UID
